...
alias mktar='sudo tar -cvf'
alias mkbz2='sudo tar  -cvjf'
alias mkgz='sudo tar -cvzf'
alias untar='sudo tar -xvf'
alias unbz2='sudo tar -xvjf'
alias ungz='sudo tar -xvzf'
...
alias cv='cd /home/neto/VisualCodeHaven/'
